...
function renderMessages(messages) {
  ...
  if (messages.length === 0) {
    ...
    const emptyText = currentLang === "ar" 
      ? "لسه مفيش تهاني أو تعليقات. ابدأ أنت واكتب أول رسالة ودعوة حلوة للعروسين أحمد وخلود! ♥"
      : "No wishes yet. Be the first to send your blessing to Ahmed & Khlood! ♥";
...
if (wishForm && btnSubmit) {
  wishForm.addEventListener("submit", async (e) => {
    ...
    try {
      ...
      if (typeof Swal !== "undefined") {
        Swal.fire({
          title: currentLang === "ar" ? "تم الإرسال بحب! ♥" : "Sent with Love! ♥",
          text: currentLang === "ar" ? "تم إضافة رسالتك الجميلة لدفتر زوار أحمد وخلود.. شكراً لمشاعرك الطيبة ♥" : "Your heartfelt wish has been added to Ahmed & Khlood's real-time guestbook.",
          icon: "success",
